...
EWRAM_DATA struct MusicPlayerInfo gUnknown_0201B4F0 = {0};
EWRAM_DATA struct MusicPlayerInfo gUnknown_0201B530 = {0};
EWRAM_DATA u8 gMPlayMemAccArea[16] = {0};
...
extern void DummyFunc_rev(void);

// Strange how this function is altered to disable DMA2. Did the developers have m4a source access?
...
//        REG_DMA2CNT = ((DMA_ENABLE | DMA_START_NOW | DMA_32BIT | DMA_SRC_INC | DMA_DEST_FIXED) << 16) | 4;
    ...
    REG_SOUNDCNT_X = SOUND_MASTER_ENABLE
                   ...
                   | SOUND_2_ON
                   | SOUND_1_ON;
    REG_SOUNDCNT_H = 0xB0E; // TODO: Registers
    REG_SOUNDBIAS_H = (REG_SOUNDBIAS_H & 0x3F) | 0x40;
    REG_DMA1SAD = (s32)soundInfo->pcmBuffer; // 0x040000BC
    REG_DMA1DAD = (s32)&REG_FIFO_A;
    //REG_DMA2SAD = (s32)soundInfo->pcmBuffer + PCM_DMA_BUF_SIZE;
    //REG_DMA2DAD = (s32)&REG_FIFO_B;
    SOUND_INFO_PTR = soundInfo;
    CpuFill32(0, soundInfo, 0x980); // FIXME: should be sizeof(struct SoundInfo)
...
//! @bug wrong DMA Buf Size is used for SampleFreqSet set. The m4a internal header was
//  altered in  an attempt to reduce the library size by changing it to 792, but this
//  value is not modified as well. Here the correct value is hardcoded.
#undef PCM_DMA_BUF_SIZE
...
void m4aSoundVSyncOff(void)
{
    ...
    if (soundInfo->ident >= ID_NUMBER && soundInfo->ident <= ID_NUMBER + 1)
    {
        ...
        CpuFill32(0, soundInfo->pcmBuffer, 0x630); // TODO: sizeof pcm buffer
    }
}
