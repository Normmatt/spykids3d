...
_080001AC:
	strh r0, [r3, #2]
	ldr r1, _080001C8 @ =gUnknown_02011940
	add r1, r1, r2
	ldr r0, [r1]
	bx r0
	.align 2, 0
...
_080001C8: .4byte gUnknown_02011940
...
sub_8000A28: @ 0x08000A28
	...
	adds r4, r0, #0
	eors r4, r1
	ldr r0, _08000A58 @ =gUnknown_02000ADC
	ldrb r0, [r0]
	cmp r0, #0
	bne _08000A64
	ldr r3, _08000A5C @ =gUnknown_020003E8
	ldr r2, _08000A60 @ =gUnknown_020003F8
	ldrh r1, [r2]
	adds r0, r4, #0
	bics r0, r1
	strh r0, [r3]
...
_08000A58: .4byte gUnknown_02000ADC
_08000A5C: .4byte gUnknown_020003E8
_08000A60: .4byte gUnknown_020003F8
_08000A64:
	ldr r0, _08000A84 @ =gUnknown_020003E8
	movs r1, #0
	strh r1, [r0]
	ldr r0, _08000A88 @ =gUnknown_020003F8
	strh r1, [r0]
_08000A6E:
	movs r0, #0xf
	ands r4, r0
...
_08000A7C:
	...
	bx r0
	.align 2, 0
_08000A84: .4byte gUnknown_020003E8
_08000A88: .4byte gUnknown_020003F8

	thumb_func_start RandomCapped
RandomCapped: @ 0x08000A8C
	push {lr}
	adds r1, r0, #0
	ldr r3, _08000AAC @ =gRandGenValue
	ldr r2, [r3]
...
_08017C8E:
	...
	ldr r3, _08017CA0 @ =gUnknown_03002001
	bx r3
	.align 2, 0
_08017C98: .4byte gUnknown_03007FF0
_08017C9C: .4byte 0x68736D53
_08017CA0: .4byte gUnknown_03002001
...
MidiKey2fr: @ 0x080187B4
	...
	lsls r7, r7, #0x18
_080187C8:
	ldr r3, _08018810 @ =ScaleTable
	adds r0, r6, r3
	ldrb r5, [r0]
	ldr r4, _08018814 @ =FreqTable
	movs r2, #0xf
	adds r0, r5, #0
	ands r0, r2
	lsls r0, r0, #2
	...
	bx r1
	.align 2, 0
_08018810: .4byte ScaleTable
_08018814: .4byte FreqTable
...
m4aSoundInit: @ 0x08018858
	...
	rsbs r1, r1, #0
	ands r0, r1
	ldr r1, _080188B0 @ =gUnknown_03002000
	ldr r2, _080188B4 @ =0x040000E0
	bl CpuSet
	ldr r0, _080188B8 @ =m4a_sound
	bl SoundInit
	ldr r0, _080188BC @ =m4a_cgbchn
	bl MPlayExtender
...
_0801888A:
	...
	ldrh r0, [r5, #0xa]
	strb r0, [r4, #0xb]
	ldr r0, _080188CC @ =m4a_memacc_area
	str r0, [r4, #0x18]
	adds r5, #0xc
	subs r6, #1
	cmp r6, #0
...
_080188B0: .4byte gUnknown_03002000
_080188B4: .4byte 0x040000E0
_080188B8: .4byte m4a_sound
_080188BC: .4byte m4a_cgbchn
_080188C0: .4byte 0x0097D800
_080188C4: .4byte 0x00000004
_080188C8: .4byte mplay_table
_080188CC: .4byte m4a_memacc_area
...
m4aSongNumStart: @ 0x080188DC
	push {lr}
	lsls r0, r0, #0x10
	ldr r2, _08018900 @ =mplay_table
	ldr r1, _08018904 @ =song_table
	lsrs r0, r0, #0xd
	adds r0, r0, r1
	ldrh r3, [r0, #4]
	lsls r1, r3, #1
	...
	bx r0
	.align 2, 0
_08018900: .4byte mplay_table
_08018904: .4byte song_table

	thumb_func_start m4aSongNumStartOrChange
m4aSongNumStartOrChange: @ 0x08018908
	push {lr}
	lsls r0, r0, #0x10
	ldr r2, _08018934 @ =mplay_table
	ldr r1, _08018938 @ =song_table
	lsrs r0, r0, #0xd
	adds r0, r0, r1
	ldrh r3, [r0, #4]
	lsls r1, r3, #1
	...
	b _08018950
	.align 2, 0
_08018934: .4byte mplay_table
_08018938: .4byte song_table
_0801893C:
	ldr r2, [r1, #4]
	ldrh r0, [r1, #4]
	cmp r0, #0
...
m4aSongNumStartOrContinue: @ 0x08018954
	push {lr}
	lsls r0, r0, #0x10
	ldr r2, _08018980 @ =mplay_table
	ldr r1, _08018984 @ =song_table
	lsrs r0, r0, #0xd
	adds r0, r0, r1
	ldrh r3, [r0, #4]
	lsls r1, r3, #1
	...
	b _080189A4
	.align 2, 0
_08018980: .4byte mplay_table
_08018984: .4byte song_table
_08018988:
	ldr r2, [r1, #4]
	ldrh r0, [r1, #4]
	cmp r0, #0
...
m4aSongNumStop: @ 0x080189A8
	push {lr}
	lsls r0, r0, #0x10
	ldr r2, _080189D4 @ =mplay_table
	ldr r1, _080189D8 @ =song_table
	lsrs r0, r0, #0xd
	adds r0, r0, r1
	ldrh r3, [r0, #4]
	lsls r1, r3, #1
...
_080189CE:
	...
	bx r0
	.align 2, 0
_080189D4: .4byte mplay_table
_080189D8: .4byte song_table

	thumb_func_start m4aSongNumContinue
m4aSongNumContinue: @ 0x080189DC
	push {lr}
	lsls r0, r0, #0x10
	ldr r2, _08018A08 @ =mplay_table
	ldr r1, _08018A0C @ =song_table
	lsrs r0, r0, #0xd
	adds r0, r0, r1
	ldrh r3, [r0, #4]
	lsls r1, r3, #1
...
_08018A02:
	...
	bx r0
	.align 2, 0
_08018A08: .4byte mplay_table
_08018A0C: .4byte song_table
...
MPlayExtender: @ 0x08018B14
	...
	movs r0, #0x77
	strb r0, [r3]
	ldr r0, _08018BE8 @ =gUnknown_03007FF0
	ldr r4, [r0]
	ldr r6, [r4]
	...
	adds r0, r6, #1
	str r0, [r4]
	ldr r1, _08018BF0 @ =ExtMPlyJmpTbl
...
_08018BE8: .4byte gUnknown_03007FF0
_08018BEC: .4byte 0x68736D53
_08018BF0: .4byte ExtMPlyJmpTbl
...
ClearChain_rev: @ 0x08018C30
	push {lr}
	ldr r1, _08018C40 @ =gUnknown_0201B3A8
	ldr r1, [r1]
	bl _call_via_r1
	pop {r0}
	bx r0
	.align 2, 0
_08018C40: .4byte gUnknown_0201B3A8

	thumb_func_start Clear64byte_rev
Clear64byte_rev: @ 0x08018C44
	push {lr}
	ldr r1, _08018C54 @ =gUnknown_0201B3AC
	ldr r1, [r1]
	bl _call_via_r1
	pop {r0}
	bx r0
	.align 2, 0
_08018C54: .4byte gUnknown_0201B3AC
...
_08018C74:
	...
	str r0, [r1]
	ldr r0, _08018D0C @ =gUnknown_03007FF0
	str r5, [r0]
	str r3, [sp]
	...
	str r0, [r5, #0x30]
	str r0, [r5, #0x3c]
	ldr r4, _08018D1C @ =ExtMPlyJmpTbl
	adds r0, r4, #0
	bl MPlyJmpTblCopy
	str r4, [r5, #0x34]
	movs r0, #0x80
...
SampFreqSet_rev01: @ 0x08018D24
	push {r4, r5, r6, lr}
	adds r2, r0, #0
	ldr r0, _08018DA4 @ =gUnknown_03007FF0
	ldr r4, [r0]
	movs r0, #0xf0
	lsls r0, r0, #0xc
	ands r0, r2
	...
	movs r6, #0
	strb r2, [r4, #8]
	ldr r1, _08018DA8 @ =gUnknown_087427A4
	subs r0, r2, #1
	lsls r0, r0, #1
	adds r0, r0, r1
	ldrh r5, [r0]
...
_08018D90:
	...
	bx r0
	.align 2, 0
_08018DA4: .4byte gUnknown_03007FF0
_08018DA8: .4byte gUnknown_087427A4
...
SoundMode: @ 0x08018DC8
	push {r4, r5, lr}
	adds r3, r0, #0
	ldr r0, _08018E54 @ =gUnknown_03007FF0
	ldr r5, [r0]
	ldr r1, [r5]
...
_08018E4E:
	...
	bx r0
	.align 2, 0
_08018E54: .4byte gUnknown_03007FF0
...
SoundClear_rev01: @ 0x08018E60
	push {r4, r5, r6, r7, lr}
	ldr r0, _08018EAC @ =gUnknown_03007FF0
	ldr r6, [r0]
	ldr r1, [r6]
...
_08018EA6:
	...
	bx r0
	.align 2, 0
_08018EAC: .4byte gUnknown_03007FF0
...
SoundVSyncOff: @ 0x08018EB4
	push {lr}
	sub sp, #4
	ldr r0, _08018F00 @ =gUnknown_03007FF0
	ldr r2, [r0]
	ldr r1, [r2]
...
_08018EFA:
	...
	bx r0
	.align 2, 0
_08018F00: .4byte gUnknown_03007FF0
...
SoundVSyncOn: @ 0x08018F18
	push {r4, lr}
	ldr r0, _08018F44 @ =gUnknown_03007FF0
	ldr r2, [r0]
	ldr r3, [r2]
...
_08018F3C:
	...
	bx r0
	.align 2, 0
_08018F44: .4byte gUnknown_03007FF0
...
MPlayOpen: @ 0x08018F50
	...
	movs r4, #0x10
_08018F64:
	ldr r0, _08018FBC @ =gUnknown_03007FF0
	ldr r5, [r0]
	ldr r1, [r5]
...
_08018FB4:
	...
	bx r0
	.align 2, 0
_08018FBC: .4byte gUnknown_03007FF0
...
_08019284:
	...
	movs r5, #0x3b
_08019292:
	ldr r0, _0801929C @ =gUnknown_08742858
	adds r0, r5, r0
	ldrb r0, [r0]
	b _08019302
	.align 2, 0
_0801929C: .4byte gUnknown_08742858
_080192A0:
	cmp r5, #0x23
	bhi _080192AC
	movs r0, #0
...
_080192AC:
	...
	mov ip, r1
_080192BE:
	ldr r3, _08019308 @ =gUnknown_087427BC
	adds r0, r5, r3
	ldrb r6, [r0]
	ldr r4, _0801930C @ =gUnknown_08742840
	movs r2, #0xf
	adds r0, r6, #0
	ands r0, r2
	lsls r0, r0, #1
...
_08019302:
	...
	bx r1
	.align 2, 0
_08019308: .4byte gUnknown_087427BC
_0801930C: .4byte gUnknown_08742840
...
CgbSound: @ 0x080193C8
	...
	push {r5, r6, r7}
	sub sp, #0x1c
	ldr r0, _080193E8 @ =gUnknown_03007FF0
	ldr r0, [r0]
	str r0, [sp, #4]
	ldrb r0, [r0, #0xa]
	cmp r0, #0
	...
	b _080193F2
	.align 2, 0
_080193E8: .4byte gUnknown_03007FF0
_080193EC:
	movs r0, #0xe
	ldr r2, [sp, #4]
	strb r0, [r2, #0xa]
...
_0801976E:
	...
	cmp r6, #3
	bne _080197C0
	ldr r0, _080197BC @ =gUnknown_08742894
	ldrb r1, [r4, #9]
	adds r0, r1, r0
	ldrb r0, [r0]
	ldr r2, [sp, #0xc]
...
_080197BC: .4byte gUnknown_08742894
_080197C0:
	movs r0, #0xf
	mov r1, r8
	ands r1, r0
...
_08019BB4:
	...
	bhs _08019BD4
_08019BC0:
	ldr r0, _08019BD0 @ =gUnknown_0201B324
	ldr r2, [r0]
	adds r0, r4, #0
	adds r1, r6, #0
	bl _call_via_r2
	b _08019BDA
	.align 2, 0
_08019BD0: .4byte gUnknown_0201B324
_08019BD4:
	ldr r0, [r6, #0x40]
	adds r0, #4
	str r0, [r6, #0x40]
...
ply_xcmd: @ 0x08019BE0
	...
	bx r0
	.align 2, 0
_08019BFC: .4byte xcmd_tbl

	thumb_func_start ply_xxx
ply_xxx: @ 0x08019C00
	push {lr}
	ldr r2, _08019C10 @ =ExtMPlyJmpTbl
	ldr r2, [r2]
	bl _call_via_r2
	pop {r0}
	bx r0
	.align 2, 0
_08019C10: .4byte ExtMPlyJmpTbl
